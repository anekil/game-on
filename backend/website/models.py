...
class Game(db.Model):
    ...
    slug: Mapped[str] = mapped_column(db.String(200))
    url: Mapped[str] = mapped_column(db.String(220))
    summary: Mapped[Optional[str]] = mapped_column(db.Text(8000))
    storyline: Mapped[Optional[str]] = mapped_column(db.Text(8000))
    cover: Mapped[Optional[str]] = mapped_column(db.String(120))
    total_rating: Mapped[Optional[int]] = mapped_column(db.Integer)
    total_rating_count: Mapped[Optional[int]] = mapped_column(db.Integer)
